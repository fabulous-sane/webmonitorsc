...
>
  ...
  <div>
    <span className="text-gray-500">Період зберігання:</span>{" "}
    <b>{data.data_retention_days} днів</b>
  </div>

  <div className="text-gray-400">
    Дані старші за цей період автоматично видаляються під час очищення
  </div>
</div>
